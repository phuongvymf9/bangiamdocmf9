...
export default class KPSChiTietScreen extends PureComponent {
            ...
            <KeyboardAvoidingView style={[css.container]} behavior="padding" enabled   keyboardVerticalOffset={100}>
                <ScrollView>
                    <View style={css.formTitle}>
                        ...
                        {this._RowInfo('Số thuê bao:',this.props.navigation.state.params.dataKPS.sothuebao)}
                        {this._RowInfo('Gói cước:',this.props.navigation.state.params.dataKPS.goicuoc)}
                        {this._RowInfo('Cam kết:',this.props.navigation.state.params.dataKPS.tg_camket)}
                        {
                        ...
                        {this._RowInfo('Khách hàng:',this.props.navigation.state.params.dataKPS.khachhang)}
                        {this._RowInfo('Địa chỉ:',this.props.navigation.state.params.dataKPS.diachi)}
                    <View style={css.formTitle}>
                        <Icon 
                            name="md-information-circle"
                            size={25}
                        ...
                        {this._RowInfo('User:',this.props.navigation.state.params.dataKPS.user)}
                        {this._RowInfo('Tỉnh:',this.props.navigation.state.params.dataKPS.tentinh)}
                        {this._RowInfo('Tên cửa hàng:',this.props.navigation.state.params.dataKPS.tencuahang)}
                        {this._RowInfo('Thời gian gửi yêu cầu:',this.props.navigation.state.params.dataKPS.tg_yeucau)}
